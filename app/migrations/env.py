...
from Schema.SQL.Models import models  # noqa: F401  # Import models so SQLModel.metadata is populated

# this is the Alembic Config object, which provides
# access to the values within the .ini file in use.
config = context.config

# Load environment variables so we can read POSTGRES_URL_MIGRATIONS
load_dotenv()
...
# for 'autogenerate' support. Models are imported above so that
# all SQLModel subclasses register themselves on SQLModel.metadata.
