...
from Schema.user_schema import ReadUser, CreateUser, UpdateUser
...
def list_users(
    ...
    logger.info(
        ...
        f"github_user_name={github_user_name}, rank={rank}"
    )
    users = service.list_users(skip, limit, sort_by, order, github_user_name, rank)
